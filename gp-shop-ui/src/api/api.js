...
export const ossUrl = "http://120.24.221.188:8000"

let host = 'http://120.24.221.188:8000';//API网关
...
export const getHotSearch = params => { return axios.get{`${host}/g/v1/hotsearchs`}}
