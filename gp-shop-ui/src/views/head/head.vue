  ...
  <div id="header" class="new_header">
    ...
    <div class="hd_main cle">
        ...
        <router-link to="/app/home/index" class="lizi_logo">
            <img src="../../static/images/head/logo.gif" alt="云熠体育商城">
        </router-link>
                        ...
                        <div class="list" v-show="showShopCar">
                            <div class="data">
                               <dl v-for="(item,index) in goods_list.goods_list">
                                <dt><router-link :to="'/app/home/productDetail/'+item.goods_id" target = _blank><img :src="item.good_image"></router-link></dt>
                                <dd>
                                  <h4><router-link :to="'/app/home/productDetail/'+item.goods_id" target = _blank>{{item.good_name}}</router-link></h4>
...
export default {
    ...
    methods:{
        ...
        searchSubmit(){
            console.log('搜索内容',this.searchWord)
            if(this.searchWord){
                //跳转到登录
...
.hufu-step a.no1:hover,#current-hstep1 a.no1{background-position:-52px -54px;color:#c81623}
.hufu-step a.no2{width:122px}
.hufu-step a.no2:hover,#current-hstep2 a.no2{background-position:-158px -54px;color:#c81623}
.hufu-step a.no3{width:109px}
.hufu-step a.no3:hover,#current-hstep3 a.no3{background-position:-280px -54px;color:#c81623}
.hufu-step a.no4{width:112px}
.hufu-step a.no4:hover,#current-hstep4 a.no4{background-position:-389px -54px;color:#c81623}
.hufu-step a.no5{width:117px}
.hufu-step a.no5:hover,#current-hstep5 a.no5{background-position:-501px -54px;color:#c81623}
.hufu-step a.no6{width:120px}
.hufu-step a.no6:hover,#current-hstep6 a.no6{background-position:-618px -54px;color:#c81623}
.hufu-step a.no7{width:104px}
.hufu-step a.no7:hover,#current-hstep7 a.no7{background-position:-738px -54px;color:#c81623}
.hufu-step a.no8{width:124px;padding-top:55px}
.hufu-step a.no8:hover,#current-hstep8 a.no8{background-position:-842px -54px;color:#c81623}
.caiz-step{background-position:0 -108px;background-color:#fdfdfd}
.caiz-step a.no1{width:88px}
.caiz-step a.no1:hover,#current-cstep1 a.no1{background-position:-52px -162px;color:#c81623}
.caiz-step a.no2{width:92px}
.caiz-step a.no2:hover,#current-cstep2 a.no2{background-position:-140px -162px;color:#c81623}
.caiz-step a.no3{width:84px}
.caiz-step a.no3:hover,#current-cstep3 a.no3{background-position:-232px -162px;color:#c81623}
.caiz-step a.no4{width:92px}
.caiz-step a.no4:hover,#current-cstep4 a.no4{background-position:-316px -162px;color:#c81623}
.caiz-step a.no5{width:86px}
.caiz-step a.no5:hover,#current-cstep5 a.no5{background-position:-408px -162px;color:#c81623}
.caiz-step a.no6{width:85px}
.caiz-step a.no6:hover,#current-cstep6 a.no6{background-position:-494px -162px;color:#c81623}
.caiz-step a.no7{width:95px}
.caiz-step a.no7:hover,#current-cstep7 a.no7{background-position:-579px -162px;color:#c81623}
.caiz-step a.no8{width:82px}
.caiz-step a.no8:hover,#current-cstep8 a.no8{background-position:-674px -162px;color:#c81623}
.caiz-step a.no9{width:90px}
.caiz-step a.no9:hover,#current-cstep9 a.no9{background-position:-756px -162px;color:#c81623}
.caiz-step a.no10{width:120px;padding-top:55px}
.caiz-step a.no10:hover,#current-cstep10 a.no10{background-position:-846px -162px;color:#c81623}
...
.fixed-want dd a.red{color:#c81623;background-color:#ffecf2;border-radius:3px}
...
.search-selected a.item{border:1px solid #ddd;background-color:#fff;margin-right:8px;background-position:right -245px;box-shadow:0 1px 1px #eee;color:#c81623}
...
.cms-box .bd a:hover span.name{color:#c81623}
.baokuan-goods a,.baokuan-goods a span{display:block}
.baokuan-goods a span.price{color:#c81623}
...
.seemore_items h3 a:hover{text-decoration:none;color:#c81623}
