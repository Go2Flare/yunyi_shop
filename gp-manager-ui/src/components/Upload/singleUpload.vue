  ...
  export default {
    ...
    methods: {
      ...
      handlePreview(file) {
       ...
       beforeUpload2(file) {
        ...
        let body = send_request()
            ...
            _self.dataObj.key = obj.dir + file.name
            ...
            // console.log(obj.dir + '${filename}')
            // console.log(obj.dir + file.name)
            // console.log(obj.key + file.name)
      ...
      handleUploadSuccess(res, file) {
        ...
        if(!this.useOss){
          //不使用oss直接获取图片路径
          console.log('不使用oss直接获取图片路径')
          url = res.data.url;
          console.log(url)
        }
        // console.log('handleUploadSuccess')
        // console.log(this.dataObj.host)
        // console.log(this.dataObj.key)
        // console.log(file.name)
        // console.log(this.dataObj.dir)
        // console.log('这里的url：',url)
        // console.log('拼接')
        // console.log(this.dataObj.host+'/'+file.name)
