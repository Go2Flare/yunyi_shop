...
func main() {
	//dsn := "root:4.234.23123aa@tcp(192.168.0.104:3306)/mxshop_inventory_srv?charset=utf8mb4&parseTime=True&loc=Local"
	dsn := "root:4.234.23123aa@tcp(47.106.87.191:3306)/shop_inventory_srv?charset=utf8mb4&parseTime=True&loc=Local"
