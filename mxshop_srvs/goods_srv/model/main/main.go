...
func main() {
	dsn := "root:4.234.23123aa@tcp(47.106.87.191:3306)/shop_goods_srv?charset=utf8mb4&parseTime=True&loc=Local"
...
//废弃
func Mysql2Es() {
	dsn := "root:4.234.23123aa@tcp(192.168.0.104:3306)/mxshop_goods_srv?charset=utf8mb4&parseTime=True&loc=Local"
	...
	_ = db.AutoMigrate(&model.Goods{}, &model.Brands{}, &model.Banner{}, &model.Category{})
	//es配置
	host := "http://120.78.192.25:9200"
